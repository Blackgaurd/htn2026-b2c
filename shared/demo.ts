...
const SEEDS: readonly DemoReviewSeed[] = [
  ...
  { user_id: 1, bathroom_id: 6, rating: 5, note: "Spotless every single time. The lighting actually makes you look good.", created_at: "2026-09-15 10:12:00" },
  { user_id: 1, bathroom_id: 3, rating: 5, note: "Single occupancy, locks properly, nobody knocks. Elite.", created_at: "2026-09-15 15:40:00" },
  { user_id: 1, bathroom_id: 21, rating: 5, note: "Nobody knows about this one. Keep it that way.", created_at: "2026-09-16 13:05:00" },
  { user_id: 1, bathroom_id: 17, rating: 3, note: "Fine. Gets busy right after the 11:30 lectures let out.", created_at: "2026-09-16 16:22:00" },
  { user_id: 1, bathroom_id: 14, rating: 3, note: "Central, so it's always a bit of a scene.", created_at: "2026-09-17 09:48:00" },
  { user_id: 1, bathroom_id: 9, rating: 3, note: "Soap dispenser has been empty since week 2.", created_at: "2026-09-17 14:33:00" },
  { user_id: 1, bathroom_id: 19, rating: 1, note: "The hand dryer is louder than the fire alarm and the floor was wet.", created_at: "2026-09-18 11:09:00" },
